...
parser.add_argument("--optimized", action='store_true', help="uses less vram at cost of performance")
parser.add_argument("--cli", type=str, help="don't launch web server, take Python function kwargs from this file.", default=None)
#parser.add_argument("--no-progressbar-hiding", action='store_true', help="enable progress bar display in WebUI", default=True)
