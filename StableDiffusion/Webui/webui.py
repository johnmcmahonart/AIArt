...
parser.add_argument("--no-progressbar-hiding", action='store_false', help="do not hide progressbar in gradio UI (we hide it because it slows down ML if you have hardware accleration in browser)")
parser.add_argument("--max-batch-count", type=int, default=500, help="maximum batch count value for the UI")
...
parser.add_argument("--jpeg-quality", type=int, default=100, help="quality for saved jpeg images")
